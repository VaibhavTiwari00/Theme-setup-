...
<head>
    ...
    <meta content="Vaibhav" name="author" />
...
<body class="authentication-bg position-relative">
    <div class="account-pages pt-2 pt-sm-2 pb-4 pb-sm-2 position-relative">
        <div class="container">
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="text-dark">
            <script>document.write(new Date().getFullYear())</script> © Laravel - Made by Vaibhav
        </span>
    </footer>
    <!-- Theme Config Js -->
